...
//#define _DUTY_MIN 600.0 // 0 > 90 degree until 300seconds
//#define _DUTY_NEU 1300.0 // 0 > 90 degree until 300seconds
//#define _DUTY_MAX 1500.0 // 0 > 90 degree until 300seconds
...
void setup() {
  ...
  //(float)(_DUTY_MAX - _DUTY_MIN) * (_SERVO_SPEED / 90.0) * (INTERVAL / 1000.0); // 0 > 90 degrees until 300 seconds
